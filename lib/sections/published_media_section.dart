...
class PublishedMediaSection extends StatelessWidget {
  const PublishedMediaSection({super.key});
  ...
  static const List<Map<String, String>> _mediaItems = [
    {
      'title': 'APTDC Tourism App (Andhra Pradesh Tourism) Demo',
    ...
    },
    {
      ...
      'thumbnail': 'assets/video_thumbnail.jpg',
      'url': 'https://banti-rathod-tech.web.app/',
    },
    {
