...
import '../adaptive/text_size_manager.dart';
...
class _ProjectsSectionState extends State<ProjectsSection> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Showcasing my Flutter development expertise',
      ...
      builder: (context, constraints) {
        final cardWidth =
            (constraints.maxWidth -
                (crossAxisCount - 1) *
                    LayoutBreakpoints.cardHorizontalSpacing) /
            crossAxisCount;
        ...
        return GridView.builder(
          ...
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            ...
            crossAxisSpacing: LayoutBreakpoints.cardHorizontalSpacing,
            mainAxisSpacing: LayoutBreakpoints.cardVerticalSpacing,
            childAspectRatio: cardWidth / 300, // Adjust card height ratio
          ),
  ...
  int _getCrossAxisCount(double screenWidth) {
    if (screenWidth > 1200) return 3; // Up to 4 cards on large screens
  ...
  final List<Map<String, dynamic>> projects = [
    {
      ...
      'imageUrl':
          'assets/construction_app.png', // Placeholder - replace with actual image
    },
    {
    ...
    },
    {
      ...
      'imageUrl':
          'assets/fitness_app.png', // Placeholder - replace with actual image
    },
    {
...
class _ProjectCardState extends State<ProjectCard>
  ...
  String _getTruncatedDescription(BuildContext context) {
    final textStyle = Theme.of(context).textTheme.bodyMedium?.copyWith(
      fontSize: TextSizeManager.getDynamicTextSize(context, baseSize: 11.0),
      height: 1.4,
